...
class State(ordered_bunch):
    ...
    def find_files(self,config):
        ...
        if ('MODEL_FORCE_X_SUP' in config.keys()): register_file('MODEL_FORCE_X_SUP',config.MODEL_FORCE_X_SUP)
        ...
        if ('MODEL_FORCE_X_SUB' in config.keys()): register_file('MODEL_FORCE_X_SUB',config.MODEL_FORCE_X_SUB)
        if ('MODEL_FORCE_Z_SUB' in config.keys()): register_file('MODEL_FORCE_Z_SUB',config.MODEL_FORCE_Z_SUB)
        if ('MODEL_MOMENT_Y_SUB' in config.keys()): register_file('MODEL_MOMENT_Y_SUB',config.MODEL_MOMENT_Y_SUB)
